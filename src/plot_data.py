...
def main():
    ...
    plot_number_operations_vs_number_of_vertices(greedy_data, "greedy", log=False, save=True)
    plot_time_vs_number_of_vertices(greedy_data, "greedy", log=False, save=True)
    plot_number_of_solutions_tested_vs_graph_size(greedy_data, "greedy", log=False, save=True)
